                    ...
                    <div class="col-12 mb-2">
                        <form action="/../admin/settings/general" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="email" name="email" value="<?php echo $settings->email ?>" class="form-control" placeholder="coloque o email" required>
                            </div>
                            <div class="mb-2">
                                <label class="form-label">Número de Telefone </label>
                                <input type="number" name="phone" value="<?php echo $settings->phone ?>" class="form-control" placeholder="Coloque o Número de Telefone">
                            </div>
                    ...
                    <div class="col-12 mb-2">
                        <form action="/../admin/settings/logos" method="POST" enctype="multipart/form-data">
                            <div class="mb-2">
                                ...
                                <?php if ($settings->site_logo) echo '<img src="/' . $settings->site_logo . '" width="200" height="50" style="object-fit: cover;" alt="">'; ?>
                                <input type="file" name="site_logo[]" class="form-control">
                            </div>
                            <div class="mb-2">
                                <label class="form-label">Logotipo <small>(Versão Dark ou Transparente / Opcional)</small></label>
                                <small class="text-danger d-block  mb-0">Em caso de alteração, é substituido o logotipo actual, caso exista.</small>
                                <?php if ($settings->site_logo_dark) echo '<img src="/' . $settings->site_logo_dark . '" width="200" height="50" style="object-fit: cover;" alt="">'; ?>
                                <input type="file" name="site_logo_dark[]" class="form-control">
                            </div>

                            <div class="form-check form-switch form-check-md mb-3">
                                <input class="form-check-input" name="show_image" value="1" type="checkbox" <?php if ($settings->show_logo) echo 'checked' ?> <?php if (!$settings->site_logo) echo 'disabled' ?>>
                    ...
                    <div class="col-12 mb-2">
                        <form action="/../admin/settings/social-media" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="facebook" value="<?php echo $settings->facebook ?>" class="form-control" placeholder="Coloque o link do seu Perfil">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="linkedin" value="<?php echo $settings->linkedin ?>" class="form-control" placeholder="Coloque o link do seu Perfil">
                            </div>
