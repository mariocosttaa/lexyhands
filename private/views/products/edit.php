...
<div class="card">
    <div class="card-body">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" name="name" value="<?php echo $product->name ?>" placeholder="Coloque o Nome do Produto" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-2">
                    ...
                    <div id="collapseDescription" class="accordion-collapse collapse show" aria-labelledby="productDescription" data-bs-parent="#productDescription">
                        <div class="accordion-body">
                            <div class="col-12 mb-2">
                                ...
                                <textarea id="editor" name="description" placeholder="Escreva o conteúdo do Serviço" required><?php echo $product->description ?>
                                        </textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div id="priceContainer">
                                <div class="row price-row" data-row-id="<?php echo $key + 1 ?>">
                                    ...
                                    foreach ($product->prices as $key => $price) {
                                        ...
                                        <?php if ($i !== 1) {
                                            echo '<div class="col-12"><br><hr><br></div>';
                                        } ?>
                                        ...
                                        <div class="col-md-2 mb-2">
                                            ...
                                            <input type="text" name="prices_description[]" class="form-control" placeholder="Descrição (opcionao)" value="<?php echo $price->description ?? '' ?>">
                                        </div>
                                        <div class="col-md-2 mb-8">
                                            <label for="currency<?php echo $key + 1 ?>" class="form-label">Moeda</label>
            ...
            <div class="accordion" id="productImage">
                <!-- Definição de Preço -->
                <div class="accordion-item">
                    <h2 class="accordion-header" id="productImage">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseImage" aria-expanded="true" aria-controls="collapseImage">
                          Adicionar Imagem(s) (Opcional)
                        </button>
                    </h2>
                    <div id="collapseImage" class="accordion-collapse collapse show" aria-labelledby="productImage" data-bs-parent="#productImage">
                        <div class="accordion-body">
                            <div class="col-12 mb-4">
                                <div class="mb-2">
                                    <label class="col-sm-3 col-form-label form-label"><small class="text-danger">Tamamho máximo Permitido 5 MB</small></label>
                                                ...
                                                <li class="mt-2" id="styleFile-preview-list-product-8.jpg">
                                                    <div class="border rounded">
                                                        <div class="d-flex p-2">
                                                            ...
                                                            <?php if (count(json_decode($product->images)) > 1) { ?>
            ...
            <div class="d-flex justify-content-end align-items-center mt-4">
                <button type="submit" class="btn btn-primary-soft">Actualizar Producto</button>
            </div>
        </form>
    </div>
</div>
